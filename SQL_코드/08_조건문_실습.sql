...
DECODE(SUBSTR(DEPT_CODE,1),'D1','인사관리부','D2','회계관리부','D3','마케팅부','D4','국내영업부','기타') AS "부서"
FROM EMPLOYEE;

-- 3) SELECT EMP_NAME, JOB_CODE FROM EMPLOYEE
SELECT EMP_NAME,JOB_CODE,
DECODE(SUBSTR(JOB_CODE,1),'J1','대표','J2','부사장','J3','부장','J4','차장','J5','과장','J6','대리','J7','사원','알 수 없음') as "직급"
FROM EMPLOYEE;

/*****  CASE WHEN THEN ELSE END 실습 *****/
-- 1) 급여에 따라 등급 설정 
-- 급여 600만 이상 S1 500만 이상 S2 400만 이상 S3 나머지 S4 급여등급 표기
