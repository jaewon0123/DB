...
SELECT E.EMP_ID,E.EMP_NAME,E.PHONE,E.HIRE_DATE,D.DEPT_TITLE,E.JOB_CODE,J.JOB_NAME
FROM EMPLOYEE E
JOIN department D ON E.DEPT_CODE = D.DEPT_ID
JOIN JOB J ON E.JOB_CODE = J.JOB_CODE
...
SELECT E1.EMP_ID,E1.EMP_NAME,E1.DEPT_CODE,E1.MANAGER_ID,E1.EMP_NO,E1.HIRE_DATE
FROM EMPLOYEE E1
JOIN EMPLOYEE E2
ON
AND
